...
CREATE TABLE Contact_Number (
    ...
    Number_Type_ID INT,
    Customer_ID INT,
    FOREIGN KEY (Number_Type_ID) REFERENCES Number_Type(Number_Type_ID),
...
CREATE TABLE Supplier (
    ...
    FOREIGN KEY (Address_ID) REFERENCES Addres(Address_ID)
);
...
CREATE TABLE Customer_User (
	Id_CustomerUser INT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE Technician_User (
	Id_TechnicianUser INT IDENTITY(1,1) PRIMARY KEY,
    Username NVARCHAR(50),
    Password_technician NVARCHAR(100),
    Technician_ID INT,
    FOREIGN KEY (Technician_ID) REFERENCES Technician(Technician_ID)
);
